...
<div class="body-box" style="float:right">
	<form id="jvForm" action="tarticleupdate.do?id=${tarticle.id }" method="post">
			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="title" id="title" maxlength="100" value="${tarticle.title }" onblur="chktitle()"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="content" id=""content maxlength="100"  value="${tarticle.content }" onblur="chkcontent()"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="author" id="author" maxlength="100"  value="${tarticle.author }" onblur="chkauthor()"/>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
					<span class="pn-frequired">*</span>
						所属频道:</td><td width="80%" class="pn-fcontent">
						<select name="channel">
						<c:forEach items="${channels}" var="chl">
						<c:if test="${taircle.channel==chl.id }">
						<!-- 显示所属频道 -->
