...
<div style="margin-top:15px;">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="list.do?page=${PAGE+1>PAGECONT?PAGECONT:PAGE+1}&loginname=${QUERY.loginname}
	&isenabled=${QUERY.isenabled}">下一页</a>
	&nbsp;&nbsp;&nbsp;&nbsp;
	<a href="list.do?page=${PAGECONT}&loginname=${QUERY.loginname}&isenabled=${QUERY.isenabled}">
	最后页</a>
