...
<table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
	...
	<tbody class="pn-ltbody">
		<c:forEach items="${tadverts }" var="tadvert">
			<tr bgcolor="#ffffff" onmouseover="this.bgColor='#eeeeee'" onmouseout="this.bgColor='#ffffff'">
			<td><input type="checkbox" name="ids" value="73"/></td>
			<td align="center">${tadvert.id }</td>
			<td align="center">${tadvert.title }</td>
			<td align="center">${tadvert.content }</td>
			<td align="center">${tadvert.crtime }</td>
			<td align="center">${tadvert.crman }</td>
		    <td align="center"><a href="tadvertget.do?id=${tadvert.id } " class="pn-opt">修改</a>
			<a href="tadvertdelete.do?id=${tadvert.id }"  onclick="return del()" class="pn-opt">删除</a>
			</td>
		</tr>
		</c:forEach>
	</tbody>
