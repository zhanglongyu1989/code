...
<div class="body-box" style="float:right">
	<form id="jvForm" action="../tadvertadd.do" method="post">
			...
			<tbody>
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
						...
						<input type="text" class="required" name="crman"  id="crman" maxlength="100" onblur="chkcrman()"/>
